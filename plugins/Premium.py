...
async def myplan(client, message):
    ...
    if data and data.get("expiry_time"):
        ...
        await message.reply_text(f"ʜᴇʏ {user},\n\n😓ʏᴏᴜ ᴅᴏ ɴᴏᴛ ʜᴀᴠᴇ ᴀɴʏ ᴀᴄᴛɪᴠᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs.\n\n🙃ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ 👇",
                                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("❄️ ᴄʜᴇᴄᴋᴏᴜᴛ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴꜱ ❄️", callback_data='seeplans')]]))			 
...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://media-hosting.imagekit.io//baca1c4fa91b4648/1894518.gif?Expires=1834218076&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=rBveKpZDTA-WQaBgdn6qs7CRHZrn2evsSabimuI7U5K3oLCh9HdPMAlWGr871YMcJ3yCZCRZBdMO-Z2YP9ixPgPxytGc3of2EaWQXFIcDRoUNJRHnTAXCd7QEVvUod0QowgVtb5k8W~nvIiiG71n~0psH73y0eKaiXpslEg-Tt2bboArOiCz1ZjBrHH3OEmmyPHdL3e1SMLxOKMSrscPAI1Ax9OTz5UnlaB3M-c-KXZQ9kOQFC4GOckt-dAs7kzGqbOGL54Fty1efDjPHVWgYK76XA3LeqDC7E-dzfrfPvzOlIaWc1dFVFUYL85I4YeIP8~QNKM6jQxskLz5MQrPEQ__", caption=script.PREMIUM_TEXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
