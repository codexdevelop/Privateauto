...
# y need to change "6077444526" or "767250672" user_id with yr user_id (thx ki jaruRat.. nhi he !!! )
...
async def give_filter(client, message):
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(f"<b>Hᴇʏ {message.from_user.mention},\n\n🍁ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ ɪꜱ ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ \n\n🧨 ꜰɪʟᴇꜱ ꜰᴏᴜɴᴅ : {str(total_results)}\n🧐 ꜱᴇᴀʀᴄʜ :</b> <code>{search}</code>\n\n<b>🪄 ᴛʜɪs ɪs ᴀ <u>sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ</u> 💦sᴏ ᴛʜᴀᴛ ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ғɪʟᴇs ғʀᴏᴍ ʜᴇʀᴇ...\n\n☄️ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ : 👇</b>",   
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("👻 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 👻", url=f"https://t.me/codexmoviesgroup")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🙃 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/codexmoviesgroup")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("❄️ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ ❄️", url="https://t.me/MoviesLinkSearchBot2")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("❄️ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ ❄️", url="https://t.me/MovizTube_Group")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
     ...
     # don't change anything without contacting me @ultroidxTeam or @lazyDeveloperr
        ...
        buttons = [[
            InlineKeyboardButton('🙃 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(6077444526))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('👻 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6077444526))
        ],[
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❄️ ꜱɪʟᴠᴇʀ ❄️', callback_data='silver')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❄️ ʙᴀᴄᴋ ❄️', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🥷 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(6077444526))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('🎩 ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 🎩', url='https://t.me/codexbotmaker')
        ],[
            InlineKeyboardButton('🧧 movies ɢʀᴏᴜᴘ 🧧', url='https://t.me/codexmoviesgroup'),
            InlineKeyboardButton('🧨 discuss ɢʀᴏᴜᴘ 🧨', url='https://t.me/codexdisscus')
        ],[
            InlineKeyboardButton('🗿 ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ 🪄', url='https://t.me/codexmoviesgroup')
        ],[
            InlineKeyboardButton('🗻 ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ ❄️', url='https://t.me/codexdisscus')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👻 ᴏᴡɴᴇʀ 👻', user_id=int(6077444526)),
        ...
        await query.answer("🧧 ʟɪᴠᴇ sʏsᴛᴇᴍ sᴛᴀᴛᴜs 🧧\n\n❂ ʀᴀᴍ ●●●●●●●◌◌◌\n✇ ᴄᴘᴜ ●●●●●●●◌◌◌\n✪ ᴅᴀᴛᴀ ᴛʀᴀꜰɪᴄs ●●●●◌◌◌◌◌◌ 🧨\n\nᴠ4.2 [sᴛᴀʙʟᴇ] """, show_alert=True)
        ...
        if str(grp_id) != str(grpid):
            await query.message.edit("☄️Yᴏᴜʀ Aᴄᴛɪᴠᴇ Cᴏɴɴᴇᴄᴛɪᴏɴ Hᴀs Bᴇᴇɴ Cʜᴀɴɢᴇᴅ. 💦 Gᴏ Tᴏ /connections ᴀɴᴅ ᴄʜᴀɴɢᴇ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴄᴏɴɴᴇᴄᴛɪᴏɴ.")
            return await query.answer(MSG_ALRT)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'Seaching for {search} ❄️', url=f"https://t.me/codexmoviesgroup")]]) 
            )
            search = search.lower()
            find = search.split(" ")
            search = ""
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        if not g_s:
            ...
            button = [[
                       InlineKeyboardButton("🧧 ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ", url=f"https://t.me/codexmoviesgroup")
            ]]
            if NO_RESULTS_MSG:
