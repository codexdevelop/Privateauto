...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 💤"
        m=await message.reply_text("<i>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <b>ᴛʜᴇ Movie ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ</b>.\n🫠ʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴅᴏɪɴɢ ᴡᴇʟʟ...</i>")
        await asyncio.sleep(0.4)
        await m.edit_text("🪄")
        await asyncio.sleep(0.5)
        await m.edit_text("🌪️")
        await asyncio.sleep(0.5)
        await m.edit_text("<b><i>🌬️ꜱᴛᴀʀᴛɪɴɢ...</i></b>")
        await asyncio.sleep(0.4)
        await m.delete()        
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🫧 ᴊᴏɪɴ bots ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 🫧", url=invite_link.invite_link
                )
            ]
        ]
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('🫧 ᴊᴏɪɴ bots ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 🫧', url=f'https://t.me/codexbotmaker') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        await k.edit("<b>🌋ʏᴏᴜʀ ᴍᴇꜱꜱᴀɢᴇ ɪꜱ ᴅᴇʟᴇᴛᴇᴅ !\💧nᴋɪɴᴅʟʏ ꜱᴇᴀʀᴄʜ ᴀɢᴀɪɴ.</b>")
        return
    ...
    msg = await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
             ...
             [
              InlineKeyboardButton('🫧 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 🫧', url=f'https://t.me/codexbotmaker') #Don't change anything without contacting me @LazyDeveloperr
             ]
            ]
        )
    )
...
async def delete(bot, message):
    ...
    if reply and reply.media:
        msg = await message.reply("ᴘʀᴏᴄᴇꜱꜱɪɴɢ...🌬️", quote=True)
    else:
        await message.reply('☄️ʀᴇᴘʟʏ ᴛᴏ ꜰɪʟᴇ ᴡɪᴛʜ /delete ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴇʟᴇᴛᴇ ꜰʀᴏᴍ ᴅʙ.', quote=True)
        return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        text="❄️ ɴᴏ ❄️", callback_data="close_data"
                    )
                ],
            ]
        ),
